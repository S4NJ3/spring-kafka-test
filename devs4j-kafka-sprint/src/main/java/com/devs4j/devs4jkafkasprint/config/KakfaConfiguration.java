package com.devs4j.devs4jkafkasprint.config;
...
public class KakfaConfiguration {
  ...
  public KafkaTemplate<String, String> kafkaTemplate() {
    ...
    MicrometerProducerListener<String, String> micrometerProducerListener = new MicrometerProducerListener<>(meterRegistry());
    defaultKafkaProducerFactory.addListener(micrometerProducerListener);
  ...
  public ConcurrentKafkaListenerContainerFactory<String, String> listenerContainerFactory(){
    ...
    listenerContainerFactory.setConcurrency(5); // three threads 
